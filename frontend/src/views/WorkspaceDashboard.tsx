...
export default function WorkspaceDashboard() {
  ...
  return <WorkspaceShell breadcrumbs={[{ label: 'Dashboard' }]}><div className="cc-page live-dashboard">
    <div className="cc-page-header"><div><TruthBadge state="live" /><h1 className="cc-page-title text-[36px] mt-3">ClauseChain evidence command centre</h1><p className="text-cc-ink-500 mt-1.5">Authoritative review progress, release gates and engine runs—without simulated KPIs.</p></div><div className="cc-actions"><Link className="truth-primary-link" href="/review">Open legal review <ArrowRight size={15} /></Link></div></div>
